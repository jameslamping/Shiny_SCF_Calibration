            ...
            fluidRow(
              ...
              column(4,
                ...
                tags$div(class = "card",
                  ...
                  tags$div(class = "card-body",
                    p(class = "text-muted small mb-2",
                      "Load the LANDFIRE LF2016 FRI TIF from disk. Point to the",
                      " ", tags$code(".tif"), " inside the ", tags$code("Tif/"),
                      " subfolder. The companion attribute table CSV is auto-detected",
                      " from ", tags$code("CSV_Data/"), " in the same product folder",
                      " and used to convert class codes to actual FRI years",
                      " (", tags$code("FRI_ALLFIR"), " column, all fire types combined).",
                      " Download from ",
                      tags$a("landfire.gov", href = "https://landfire.gov",
                             target = "_blank"),
                      " → LF2016 → Fire Regime → FRI."),
